...
def preprocess_image(image_path, target_max_dim=1920):
    """
    Loads and preprocesses container images:
    - Bilateral noise filtering (smooths texture, keeps edges crisp)
    - Unsharp mask deblurring
    - LAB b* yellow color isolation + CLAHE
    - Morphological stencil closing
    - Produces enhanced color image and clean binarized masks
    """
